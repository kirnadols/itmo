input_json_file = "input_schedule.json"
output_xml_file = "output_main.xml"

with open(input_json_file, "r", encoding="utf-8") as file:
    data = file.read()

screened_data = data.replace("<", r"\<")

with open(input_json_file, "w", encoding="utf-8") as file:
    file.write(screened_data)

print(f"Обработка завершена! Результат сохранён в {input_json_file}")
